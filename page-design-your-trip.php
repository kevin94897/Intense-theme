        ...
        <div class="container-site max-w-3xl mx-auto px-4">
            ...
            <div class="text-center mb-12 md:mb-16" data-aos="fade-up">
                ...
                <p class="font-body text-sm md:text-[15px] text-dark/70 max-w-2xl mx-auto leading-relaxed">
                    <?php echo esc_html(get_field('description') ?: 'Thank you for your interest in Intense Bolivia. Share a few details about your travel plans, and our designers will create a personalized journey crafted with care and authenticity.'); ?>
                </p>
            </div>
            ...
            <div class="max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                <form x-data="bookingForm()" @submit.prevent="submitForm" class="space-y-8 md:space-y-10"
                    ...
                    <div class="pt-4 flex justify-center">
                        <button type="submit" class="btn-submit-intense" :disabled="isSubmitting">
        ...
        <div class="container-site max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-3 flex items-center gap-4" data-aos="fade-right">
                    <svg width="40" height="32" viewBox="0 0 65 41" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="shrink-0 opacity-80">
                        <path d="M31.9972 27.997L18.8042 20.418L31.9972 12.8391L45.1902 20.418L31.9972 27.997Z"
                            stroke="currentColor" class="text-hover" stroke-width="1.12281" />
                        <path d="M31.9973 22.3832L28.3481 20.4183L31.9973 18.4534L35.6464 20.4183L31.9973 22.3832Z"
                            fill="currentColor" stroke="currentColor" class="text-primary" stroke-width="1.12281" />
                        <path d="M9.26025 0.488281L31.9971 13.4006L54.734 0.488281" stroke="currentColor"
                            class="text-hover" stroke-width="1.12281" />
                        <path d="M54.7339 40.3481L31.997 27.4359L9.26017 40.3481" stroke="currentColor"
                            class="text-hover" stroke-width="1.12281" />
                        <path d="M23.2954 3.29541L32.2779 8.90945L41.2603 3.29541" stroke="currentColor"
                            class="text-primary" stroke-width="1.12281" />
                        <path d="M41.2603 37.541L32.2778 31.927L23.2953 37.541" stroke="currentColor"
                            class="text-primary" stroke-width="1.12281" />
                        <path d="M64.2779 8.90942L44.0674 20.4182L64.2779 31.927" stroke="currentColor"
                            class="text-primary" stroke-width="1.12281" />
                        <path d="M0.277743 8.90942L20.4883 20.4182L0.277743 31.927" stroke="currentColor"
                            class="text-primary" stroke-width="1.12281" />
                    </svg>
                ...
                <div class="lg:col-span-9" data-aos="fade-left" x-data="{ active: null }">
                    ...
                    $faqs = [
                        [
                            'q' => 'How do I book a trip with Intense Bolivia?',
                        ...
                        [
                            ...
                            'a' => 'We recommend booking at least 2–3 months in advance, especially for peak season (June–August). That said, we can often accommodate last-minute requests.'
                        ],
                        [
                            'q' => 'Do you offer private tours only?',
                            'a' => 'Yes. All Intense Bolivia experiences are exclusively private, ensuring you travel at your own pace with a dedicated guide who adapts the journey to your interests and energy each day.'
                        ],
                    ];
                    ?>
