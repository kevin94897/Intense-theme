...
$testimonials_desc = get_field('testimonials_description', 'option') ?: 'Authentic stories from travelers who chose us to "Celebrate Life in Bolivia".';
$testimonials_list = get_field('list_of_testimonials', 'option');
?>

<section class="md:py-24 py-12 bg-cream">
