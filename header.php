            ...
            <div class="container-site">
                <div class="flex items-center justify-end py-2 text-sm text-white font-light tracking-wide">
                    <div class="flex items-center divide-x divide-neutral-gray/50">
                        ...
                        <a href="https://wa.me/<?php echo esc_attr(intense_nerd_whatsapp_number()); ?>" target="_blank" rel="noopener noreferrer" class="pr-5 pl-5 hover:text-primary transition-colors flex items-center gap-2">
        ...
        <div class="main-header">
            <div class="container-site">
                <nav class="flex items-center justify-between py-4" role="navigation" aria-label="<?php esc_attr_e('Navegación principal', 'intense-nerd-theme'); ?>">
                    ...
                    <button
                        type="button"
                        class="lg:hidden flex flex-col gap-1 p-2 cursor-pointer"
                        data-menu-toggle
