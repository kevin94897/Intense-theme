...
<footer class="bg-dark text-cream pt-16 pb-8" role="contentinfo">
    <div class="container-site">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-12 mb-0 md:mb-10">
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between py-5 md:py-0 md:mb-6 border-b border-cream/20 md:border-none md:cursor-default">
                    <h4 class="font-heading text-xl">Reservations</h4>
                    <span class="md:hidden transition-transform duration-200" :class="open ? 'rotate-45' : ''">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
                    </span>
                </button>
                <div x-show="open" x-transition class="pb-6 md:pb-0 md:!block">
            ...
            <!-- Column 2: Explore Intense Bolivia -->
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between py-5 md:py-0 md:mb-6 border-b border-cream/20 md:border-none md:cursor-default">
                    <h4 class="font-heading text-xl">Explore Intense Bolivia</h4>
                    <span class="md:hidden transition-transform duration-200" :class="open ? 'rotate-45' : ''">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
                ...
                <div x-show="open" x-transition class="pb-6 md:pb-0 md:!block">
                    ...
                    if (has_nav_menu('footer-explore')) {
                        wp_nav_menu([
                            ...
                            'container' => false,
                            'menu_class' => 'flex flex-col gap-4 mt-4 md:mt-0',
                            'fallback_cb' => false,
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between py-5 md:py-0 md:mb-6 border-b border-cream/20 md:border-none md:cursor-default">
                    <h4 class="font-heading text-xl">General</h4>
                    <span class="md:hidden transition-transform duration-200" :class="open ? 'rotate-45' : ''">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between py-5 md:py-0 md:mb-6 border-b border-cream/20 md:border-none md:cursor-default">
                    <h4 class="font-heading text-xl">Stay connected</h4>
                    <span class="md:hidden transition-transform duration-200" :class="open ? 'rotate-45' : ''">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
                ...
                <div x-show="open" x-transition class="mt-4 md:mt-0 pb-6 md:pb-0 md:!block">
                    <p class="text-sm text-cream/80 mb-6 max-w-sm">
                        Subscribe to receive curated travel inspiration from Bolivia.
                    </p>
        ...
        <div
            class="hidden md:flex flex-col lg:flex-row items-center justify-between lg:justify-start mb-8 gap-6 md:gap-10">
        ...
        <div class="border-t border-cream/20 pt-10 pb-4 flex flex-col items-center gap-6">
            <!-- Central Intense Bolivia Logo text placeholder -->
            ...
            <!-- <div class="flex items-center gap-5">
                ...
                <?php if (get_theme_mod('social_facebook')): ?>
                    <a href="<?php echo esc_url(get_theme_mod('social_facebook')); ?>" target="_blank" rel="noopener"
                        aria-label="Facebook" class="text-cream/60 hover:text-cream transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M12,2C6.477,2,2,6.477,2,12c0,5.013,3.693,9.153,8.505,9.876V14.65H8.031v-2.629h2.474v-1.749 c0-2.896,1.411-4.167,3.818-4.167c1.153,0,1.762,0.085,2.051,0.124v2.294h-1.642c-1.022,0-1.379,0.969-1.379,2.061v1.437h2.995 l-0.406,2.629h-2.588v7.247C18.235,21.236,22,17.062,22,12C22,6.477,17.523,2,12,2z" />
                ...
                <?php if (get_theme_mod('social_linkedin')): ?>
                    <a href="<?php echo esc_url(get_theme_mod('social_linkedin')); ?>" target="_blank" rel="noopener"
                        aria-label="LinkedIn" class="text-cream/60 hover:text-cream transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z" />
            ...
            <p class="body-small text-xs text-cream/70 text-center">
                &copy; Intense Bolivia 2007 &ndash; <?php echo esc_html(date('Y')); ?> &middot; All rights reserved.
            </p>
        </div>
